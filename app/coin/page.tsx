  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-white overflow-hidden relative">
      <div className="absolute top-20 left-10 opacity-20">
        <Stars size={32} className="text-yellow-300" />
      </div>
      ...
      <div className="absolute bottom-32 right-12 opacity-20">
        <Stars size={24} className="text-green-300" />
      </div>
      ...
      <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-yellow-400 rounded-full opacity-60 animate-bounce"></div>
      <div className="absolute top-1/3 right-1/4 w-1.5 h-1.5 bg-pink-400 rounded-full opacity-60 animate-pulse"></div>
      <div className="absolute bottom-1/3 left-1/3 w-2.5 h-2.5 bg-cyan-400 rounded-full opacity-40 animate-bounce delay-300"></div>

      <div className="container mx-auto px-4 py-8 flex flex-col items-center justify-center min-h-screen">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-yellow-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent mb-2">
            Coin Flip Decision
          </h1>
          <p className="text-xl text-gray-300">Let fate decide your next move</p>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/20 border border-white/30 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
                    maxLength={20}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/20 border border-white/30 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent"
                    maxLength={20}
                  />
                </div>
              </div>
          ...
          <button
            ...
            className={`px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 ${
              isFlipping
                ...
                : "bg-gradient-to-r from-yellow-400 to-orange-500 text-yellow-900 hover:from-yellow-300 hover:to-orange-400 transform hover:scale-105 shadow-lg hover:shadow-xl"
            }`}
          >
      ...
      <style jsx>{`
        ...
        @keyframes coinFlip {
          ...
          50% {
            transform: rotateY(900deg) rotateX(360deg) scale(1.1);
          }
          75% {
            transform: rotateY(1350deg) rotateX(540deg) scale(0.9);
          }
          100% {
            transform: rotateY(1800deg) rotateX(720deg);
          }
